...
{
    public class DistrictObjectContext : DbContext, IDbContext
    {
        public DistrictObjectContext(string nameOrConnectionString) : base(nameOrConnectionString) { }
        ...
        public void Install()
        {
            ...
            Database.SetInitializer<DistrictObjectContext>(null);
        ...
        {
            var dbScript = "DROP TABLE District";
