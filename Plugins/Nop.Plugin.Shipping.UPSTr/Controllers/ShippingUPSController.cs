...
using Nop.Core;
using Nop.Plugin.Shipping.UPSTr.Domain;
using Nop.Plugin.Shipping.UPSTr.Models;
using Nop.Services;
using Nop.Services.Configuration;
using Nop.Services.Localization;
using Nop.Web.Framework.Controllers;

namespace Nop.Plugin.Shipping.UPSTr.Controllers
{
    [AdminAuthorize]
    public class ShippingUPSTrController : BasePluginController
    {
        private readonly UPSSettings _upsSettings;
        private readonly ISettingService _settingService;
        private readonly ILocalizationService _localizationService;

        public ShippingUPSTrController(UPSSettings upsSettings,
        ...
        public ActionResult Configure()
        {
            ...
            return View("~/Plugins/Shipping.UPSTr/Views/ShippingUPS/Configure.cshtml", model);
        }
